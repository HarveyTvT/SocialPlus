...
public abstract class AbstractClassifier implements Serializable{
	 ...
	 * @return
	 */
	public TPredict classify(Instance instance,Type t){
	 ...
	 * @return
	 */
	public abstract TPredict classify(Instance instance,Type type, int n);
	 ...
	 * @return
	 */
	public TPredict[] classify(InstanceSet instances,Type type, int n) {
